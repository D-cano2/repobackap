...
public class PersonaController {
   ...
   /* @PostMapping("/create")
    public ResponseEntity<?> create(@RequestBody dtoEducacion dtoeducacion){
        ...
        if(personaService.existsByNombreEdu(dtoeducacion.getNombreEdu())){
